...
public class MainWindow extends JFrame implements ActionListener {
    ...
    Watchlist watchlist = new Watchlist();
     ...
     public MainWindow() {
        ...
        JLabel AnimeLabelIamge = new JLabel(new ImageIcon("./images/anime-boy-with-shummer-clothes_icon-icons.com_68058.png"));

        AnimeLabelIamge.setBounds(205 , 40 , 30 , 30);
     ...
     public void actionPerformed(ActionEvent e){
        ...
        try {
            ...
            if(!title.isEmpty() && !genre.isEmpty() && episodes > 0 && !status.isEmpty()) {
                ...
                JOptionPane.showMessageDialog(this, "Anime added to watchlist.\n" + "Title: " + title + "\n" + "Genre: " + genre + "\n" + "Episodes: " + episodes + "\n" + "Status: " + status + "\n" + "Rating: " + rating, "Success", JOptionPane.INFORMATION_MESSAGE);
                //updateDisplayArea();
            } 
            else {
